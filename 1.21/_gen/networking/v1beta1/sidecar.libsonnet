{
  ...
  spec: {
    ...
    egress: {
      ...
      '#withCaptureMode':: d.fn(help='"When the bind address is an IP, the captureMode option dictates how traffic to the listener is expected to be captured (or not)."', args=[d.arg(name='captureMode', type=d.T.string)]),
    ...
    ingress: {
      ...
      withBind(bind): { bind: bind },
      '#withCaptureMode':: d.fn(help='"The captureMode option dictates how traffic to the listener is expected to be captured (or not)."', args=[d.arg(name='captureMode', type=d.T.string)]),
      withCaptureMode(captureMode): { captureMode: captureMode },
