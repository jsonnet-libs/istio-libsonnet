{
  ...
  spec: {
    ...
    jwtRules: {
      ...
      '#withFromCookies':: d.fn(help='"List of cookie names from which JWT is expected."', args=[d.arg(name='fromCookies', type=d.T.array)]),
      withFromCookies(fromCookies): { fromCookies: if std.isArray(v=fromCookies) then fromCookies else [fromCookies] },
      '#withFromCookiesMixin':: d.fn(help='"List of cookie names from which JWT is expected."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fromCookies', type=d.T.array)]),
      withFromCookiesMixin(fromCookies): { fromCookies+: if std.isArray(v=fromCookies) then fromCookies else [fromCookies] },
      ...
      '#withSpaceDelimitedClaims':: d.fn(help='"List of JWT claim names that should be treated as space-delimited strings."', args=[d.arg(name='spaceDelimitedClaims', type=d.T.array)]),
      withSpaceDelimitedClaims(spaceDelimitedClaims): { spaceDelimitedClaims: if std.isArray(v=spaceDelimitedClaims) then spaceDelimitedClaims else [spaceDelimitedClaims] },
      '#withSpaceDelimitedClaimsMixin':: d.fn(help='"List of JWT claim names that should be treated as space-delimited strings."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='spaceDelimitedClaims', type=d.T.array)]),
      withSpaceDelimitedClaimsMixin(spaceDelimitedClaims): { spaceDelimitedClaims+: if std.isArray(v=spaceDelimitedClaims) then spaceDelimitedClaims else [spaceDelimitedClaims] },
      '#withTimeout':: d.fn(help='"The maximum amount of time that the resolver, determined by the PILOT_JWT_ENABLE_REMOTE_JWKS environment variable, will spend waiting for the JWKS to be fetched."', args=[d.arg(name='timeout', type=d.T.string)]),
