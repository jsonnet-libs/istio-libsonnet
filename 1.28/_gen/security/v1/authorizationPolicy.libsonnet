    ...
    rules: {
      ...
      from: {
        ...
        source: {
          ...
          '#withNotServiceAccounts':: d.fn(help='"Optional."', args=[d.arg(name='notServiceAccounts', type=d.T.array)]),
          withNotServiceAccounts(notServiceAccounts): { source+: { notServiceAccounts: if std.isArray(v=notServiceAccounts) then notServiceAccounts else [notServiceAccounts] } },
          '#withNotServiceAccountsMixin':: d.fn(help='"Optional."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='notServiceAccounts', type=d.T.array)]),
          withNotServiceAccountsMixin(notServiceAccounts): { source+: { notServiceAccounts+: if std.isArray(v=notServiceAccounts) then notServiceAccounts else [notServiceAccounts] } },
          ...
          '#withServiceAccounts':: d.fn(help='"Optional."', args=[d.arg(name='serviceAccounts', type=d.T.array)]),
          withServiceAccounts(serviceAccounts): { source+: { serviceAccounts: if std.isArray(v=serviceAccounts) then serviceAccounts else [serviceAccounts] } },
          '#withServiceAccountsMixin':: d.fn(help='"Optional."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='serviceAccounts', type=d.T.array)]),
          withServiceAccountsMixin(serviceAccounts): { source+: { serviceAccounts+: if std.isArray(v=serviceAccounts) then serviceAccounts else [serviceAccounts] } },
        },
      },
