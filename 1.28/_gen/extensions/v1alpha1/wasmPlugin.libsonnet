{
  ...
  spec: {
    ...
    match: {
      ...
      '#withMode':: d.fn(help='"Criteria for selecting traffic by their direction.\\n\\nValid Options: CLIENT, SERVER, CLIENT_AND_SERVER"', args=[d.arg(name='mode', type=d.T.string)]),
    ...
    vmConfig: {
      ...
      env: {
        ...
        '#withValueFrom':: d.fn(help="\"Source for the environment variable's value.\\n\\nValid Options: INLINE, HOST\"", args=[d.arg(name='valueFrom', type=d.T.string)]),
    ...
    '#withFailStrategy':: d.fn(help='"Specifies the failure behavior for the plugin due to fatal errors.\\n\\nValid Options: FAIL_CLOSE, FAIL_OPEN, FAIL_RELOAD"', args=[d.arg(name='failStrategy', type=d.T.string)]),
    withFailStrategy(failStrategy): { spec+: { failStrategy: failStrategy } },
    '#withImagePullPolicy':: d.fn(help='"The pull behaviour to be applied when fetching Wasm module by either OCI image or `http/https`.\\n\\nValid Options: IfNotPresent, Always"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
    ...
    '#withPhase':: d.fn(help='"Determines where in the filter chain this `WasmPlugin` is to be injected.\\n\\nValid Options: AUTHN, AUTHZ, STATS"', args=[d.arg(name='phase', type=d.T.string)]),
    ...
    '#withType':: d.fn(help='"Specifies the type of Wasm Extension to be used.\\n\\nValid Options: HTTP, NETWORK"', args=[d.arg(name='type', type=d.T.string)]),
