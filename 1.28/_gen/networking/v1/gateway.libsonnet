{
  ...
  spec: {
    ...
    servers: {
      '#port':: d.obj(help='"The Port on which the proxy should listen for incoming connections."'),
      port: {
      ...
      tls: {
        '#tlsCertificates':: d.obj(help='"Only one of `server_certificate`, `private_key` or `credential_name` or `credential_names` or `tls_certificates` should be specified."'),
        tlsCertificates: {
          '#withCaCertificates':: d.fn(help='', args=[d.arg(name='caCertificates', type=d.T.string)]),
          withCaCertificates(caCertificates): { caCertificates: caCertificates },
          ...
          withServerCertificate(serverCertificate): { serverCertificate: serverCertificate },
        },
        '#withCaCertCredentialName':: d.fn(help='"For mutual TLS, the name of the secret or the configmap that holds CA certificates."', args=[d.arg(name='caCertCredentialName', type=d.T.string)]),
        withCaCertCredentialName(caCertCredentialName): { tls+: { caCertCredentialName: caCertCredentialName } },
        ...
        '#withCredentialNames':: d.fn(help='"Same as CredentialName but for multiple certificates."', args=[d.arg(name='credentialNames', type=d.T.array)]),
        withCredentialNames(credentialNames): { tls+: { credentialNames: if std.isArray(v=credentialNames) then credentialNames else [credentialNames] } },
        '#withCredentialNamesMixin':: d.fn(help='"Same as CredentialName but for multiple certificates."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='credentialNames', type=d.T.array)]),
        withCredentialNamesMixin(credentialNames): { tls+: { credentialNames+: if std.isArray(v=credentialNames) then credentialNames else [credentialNames] } },
        ...
        '#withTlsCertificates':: d.fn(help='"Only one of `server_certificate`, `private_key` or `credential_name` or `credential_names` or `tls_certificates` should be specified."', args=[d.arg(name='tlsCertificates', type=d.T.array)]),
        withTlsCertificates(tlsCertificates): { tls+: { tlsCertificates: if std.isArray(v=tlsCertificates) then tlsCertificates else [tlsCertificates] } },
        '#withTlsCertificatesMixin':: d.fn(help='"Only one of `server_certificate`, `private_key` or `credential_name` or `credential_names` or `tls_certificates` should be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tlsCertificates', type=d.T.array)]),
        withTlsCertificatesMixin(tlsCertificates): { tls+: { tlsCertificates+: if std.isArray(v=tlsCertificates) then tlsCertificates else [tlsCertificates] } },
      ...
      '#withBind':: d.fn(help='"The ip or the Unix domain socket to which the listener should be bound to."', args=[d.arg(name='bind', type=d.T.string)]),
    ...
    '#withSelector':: d.fn(help='"One or more labels that indicate a specific set of pods/VMs on which this gateway configuration should be applied."', args=[d.arg(name='selector', type=d.T.object)]),
    withSelector(selector): { spec+: { selector: selector } },
    '#withSelectorMixin':: d.fn(help='"One or more labels that indicate a specific set of pods/VMs on which this gateway configuration should be applied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='selector', type=d.T.object)]),
