{
  ...
  spec: {
    ...
    '#withPluginConfig':: d.fn(help='"The configuration that will be passed on to the plugin."', args=[d.arg(name='pluginConfig', type=d.T.any)]),
    ...
    '#withPriority':: d.fn(help='"Determines ordering of `WasmPlugins` in the same `phase`."', args=[d.arg(name='priority', type=d.T.any)]),
