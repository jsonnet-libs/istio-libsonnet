---
permalink: /1.28/security/v1beta1/requestAuthentication/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.jwtRules`](#obj-specjwtrules)
    ...
    * [`fn withSpaceDelimitedClaims(spaceDelimitedClaims)`](#fn-specjwtruleswithspacedelimitedclaims)
    * [`fn withSpaceDelimitedClaimsMixin(spaceDelimitedClaims)`](#fn-specjwtruleswithspacedelimitedclaimsmixin)
...
### fn spec.jwtRules.withSpaceDelimitedClaims

```ts
withSpaceDelimitedClaims(spaceDelimitedClaims)
```

"List of JWT claim names that should be treated as space-delimited strings."

### fn spec.jwtRules.withSpaceDelimitedClaimsMixin

```ts
withSpaceDelimitedClaimsMixin(spaceDelimitedClaims)
```
