---
permalink: /1.28/networking/v1alpha3/gateway/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.servers`](#obj-specservers)
    ...
    * [`obj spec.servers.tls`](#obj-specserverstls)
      * [`fn withCaCertCredentialName(caCertCredentialName)`](#fn-specserverstlswithcacertcredentialname)
      ...
      * [`fn withCredentialNames(credentialNames)`](#fn-specserverstlswithcredentialnames)
      * [`fn withCredentialNamesMixin(credentialNames)`](#fn-specserverstlswithcredentialnamesmixin)
      ...
      * [`fn withTlsCertificates(tlsCertificates)`](#fn-specserverstlswithtlscertificates)
      * [`fn withTlsCertificatesMixin(tlsCertificates)`](#fn-specserverstlswithtlscertificatesmixin)
      ...
      * [`obj spec.servers.tls.tlsCertificates`](#obj-specserverstlstlscertificates)
        * [`fn withCaCertificates(caCertificates)`](#fn-specserverstlstlscertificateswithcacertificates)
        * [`fn withPrivateKey(privateKey)`](#fn-specserverstlstlscertificateswithprivatekey)
        * [`fn withServerCertificate(serverCertificate)`](#fn-specserverstlstlscertificateswithservercertificate)
...
### fn spec.servers.tls.withCaCertCredentialName
...
### fn spec.servers.tls.withCredentialNames
...
### fn spec.servers.tls.withCredentialNamesMixin
...
### fn spec.servers.tls.withTlsCertificates
...
### fn spec.servers.tls.withTlsCertificatesMixin
...
## obj spec.servers.tls.tlsCertificates

"Only one of `server_certificate`, `private_key` or `credential_name` or `credential_names` or `tls_certificates` should be specified."

### fn spec.servers.tls.tlsCertificates.withCaCertificates
...
### fn spec.servers.tls.tlsCertificates.withPrivateKey
...
### fn spec.servers.tls.tlsCertificates.withServerCertificate
