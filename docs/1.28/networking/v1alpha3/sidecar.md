---
permalink: /1.28/networking/v1alpha3/sidecar/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.ingress`](#obj-specingress)
    ...
    * [`obj spec.ingress.tls`](#obj-specingresstls)
      * [`fn withCaCertCredentialName(caCertCredentialName)`](#fn-specingresstlswithcacertcredentialname)
      ...
      * [`fn withCredentialNames(credentialNames)`](#fn-specingresstlswithcredentialnames)
      * [`fn withCredentialNamesMixin(credentialNames)`](#fn-specingresstlswithcredentialnamesmixin)
      ...
      * [`fn withTlsCertificates(tlsCertificates)`](#fn-specingresstlswithtlscertificates)
      * [`fn withTlsCertificatesMixin(tlsCertificates)`](#fn-specingresstlswithtlscertificatesmixin)
      ...
      * [`obj spec.ingress.tls.tlsCertificates`](#obj-specingresstlstlscertificates)
        * [`fn withCaCertificates(caCertificates)`](#fn-specingresstlstlscertificateswithcacertificates)
        * [`fn withPrivateKey(privateKey)`](#fn-specingresstlstlscertificateswithprivatekey)
        * [`fn withServerCertificate(serverCertificate)`](#fn-specingresstlstlscertificateswithservercertificate)
...
### fn spec.ingress.tls.withCaCertCredentialName

```ts
withCaCertCredentialName(caCertCredentialName)
```
...
### fn spec.ingress.tls.withCredentialNames

```ts
withCredentialNames(credentialNames)
```

"Same as CredentialName but for multiple certificates."

### fn spec.ingress.tls.withCredentialNamesMixin

```ts
withCredentialNamesMixin(credentialNames)
```
...
### fn spec.ingress.tls.withTlsCertificates
...
### fn spec.ingress.tls.withTlsCertificatesMixin

```ts
withTlsCertificatesMixin(tlsCertificates)
```
...
## obj spec.ingress.tls.tlsCertificates

"Only one of `server_certificate`, `private_key` or `credential_name` or `credential_names` or `tls_certificates` should be specified."

### fn spec.ingress.tls.tlsCertificates.withCaCertificates
...
### fn spec.ingress.tls.tlsCertificates.withPrivateKey
...
### fn spec.ingress.tls.tlsCertificates.withServerCertificate
