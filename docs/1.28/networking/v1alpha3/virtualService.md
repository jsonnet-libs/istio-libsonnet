---
permalink: /1.28/networking/v1alpha3/virtualService/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.http`](#obj-spechttp)
    ...
    * [`obj spec.http.retries`](#obj-spechttpretries)
      ...
      * [`fn withBackoff(backoff)`](#fn-spechttpretrieswithbackoff)
      * [`fn withPerTryTimeout(perTryTimeout)`](#fn-spechttpretrieswithpertrytimeout)
      * [`fn withRetryIgnorePreviousHosts(retryIgnorePreviousHosts)`](#fn-spechttpretrieswithretryignoreprevioushosts)
...
### fn spec.http.retries.withBackoff
...
### fn spec.http.retries.withRetryIgnorePreviousHosts

```ts
withRetryIgnorePreviousHosts(retryIgnorePreviousHosts)
```
