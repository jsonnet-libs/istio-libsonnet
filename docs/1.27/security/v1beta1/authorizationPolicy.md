---
permalink: /1.27/security/v1beta1/authorizationPolicy/
---
  ...
  * [`obj spec.rules`](#obj-specrules)
    ...
    * [`obj spec.rules.from`](#obj-specrulesfrom)
      * [`obj spec.rules.from.source`](#obj-specrulesfromsource)
        ...
        * [`fn withNotServiceAccounts(notServiceAccounts)`](#fn-specrulesfromsourcewithnotserviceaccounts)
        * [`fn withNotServiceAccountsMixin(notServiceAccounts)`](#fn-specrulesfromsourcewithnotserviceaccountsmixin)
        ...
        * [`fn withServiceAccounts(serviceAccounts)`](#fn-specrulesfromsourcewithserviceaccounts)
        * [`fn withServiceAccountsMixin(serviceAccounts)`](#fn-specrulesfromsourcewithserviceaccountsmixin)
...
### fn spec.rules.from.source.withNotServiceAccounts

```ts
withNotServiceAccounts(notServiceAccounts)
```

"Optional."

### fn spec.rules.from.source.withNotServiceAccountsMixin

```ts
withNotServiceAccountsMixin(notServiceAccounts)
```
...
### fn spec.rules.from.source.withServiceAccounts
...
### fn spec.rules.from.source.withServiceAccountsMixin
