{
  ...
  spec: {
    ...
    '#withLocation':: d.fn(help='"Specify whether the service should be considered external to the mesh or part of the mesh."', args=[d.arg(name='location', type=d.T.string)]),
    ...
    '#withResolution':: d.fn(help='"Service resolution mode for the hosts."', args=[d.arg(name='resolution', type=d.T.string)]),
